...
/obj/structure/machinery/computer/telecomms/traffic/attackby(obj/item/attacking_item, mob/user)
...
/obj/structure/machinery/computer/telecomms/traffic/emag_act(var/remaining_charges, var/mob/user)
	if(!emagged)
