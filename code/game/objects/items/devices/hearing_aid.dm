...
/obj/item/storage/hearing_aid_case
	...
	w_class = WEIGHT_CLASS_SMALL
	can_hold = list(/obj/item/hearing_aid)
	icon = 'icons/obj/item/hearing_aid.dmi'
	icon_state = "hearing_aid_case"
	storage_slots = 2
	starts_with = list(/obj/item/hearing_aid = 2)

/obj/item/storage/hearing_aid_case/black
	starts_with = list(/obj/item/hearing_aid/black = 2)

/obj/item/storage/hearing_aid_case/silver
	starts_with = list(/obj/item/hearing_aid/silver = 2)

/obj/item/storage/hearing_aid_case/white
	starts_with = list(/obj/item/hearing_aid/white = 2)

/obj/item/storage/hearing_aid_case/skrell
	starts_with = list(/obj/item/hearing_aid/skrell = 2)
